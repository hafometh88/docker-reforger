...
RCON can be activated by defining all three required environment variables: `RCON_ADDRESS`, `RCON_PORT`, and `RCON_PASSWORD`.

```sh
-e RCON_ADDRESS="0.0.0.0" \
-e RCON_PORT="19999" \
...
If any of the three RCON environment variables are missing or empty, RCON will be completely disabled.
